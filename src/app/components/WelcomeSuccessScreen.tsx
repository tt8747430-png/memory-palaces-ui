            ...
            >
                ...
                {currentPhase >= 3 && (
                    ...
                    >
                        {[
                            ...
                            >
                                <div
                                    className="w-8 h-8 bg-gradient-to-br from-[#ADC8FF]/20 to-[#091A7A]/10 rounded-[10px] flex items-center justify-center">
                ...
                {currentPhase >= 2 && (
                    ...
                    >
                        ...
                        {/* Logo Container */}
                        <div
                            className="relative w-16 h-16 bg-card-glass border border-white/30 rounded-[16px] p-3 shadow-elevated backdrop-blur-lg">
                            <motion.div
