...
import { AuthBackground, AuthInput, ValidCheckmark, SocialLogin } from "./auth";
    ...
    <div className="flex-1 flex flex-col relative bg-white">
      ...
      <div className="flex justify-center mb-8">
        ...
        >
          ...
          {/* Main Logo Container */}
          <div className="relative w-20 h-20 bg-card-glass border border-white/30 rounded-[20px] p-3 shadow-elevated backdrop-blur-lg">
            <motion.div
