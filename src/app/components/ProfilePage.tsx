            ...
            >
                ...
                <div className="flex flex-col items-center text-center space-y-5">
                    <motion.div style={{scale: imageScale, y: imageY}} className="relative origin-bottom">
                        ...
                        />
                        <div
                            className="absolute -bottom-2.5 -right-2.5 px-3 py-1 bg-gradient-to-r from-gray-900 to-gray-800 rounded-xl shadow-lg border border-gray-700/50">
                            ...
                            >
                                ...
                                <div className="grid grid-cols-2 gap-3.5">
                                    {stats.map((stat, index) => (
                                        ...
                                        >
                                            <div
                                                className={`w-11 h-11 bg-gradient-to-br ${stat.color} rounded-[14px] flex items-center justify-center mb-4 ${stat.shadow} shadow-lg`}>
                        ...
                        {activeTab === "achievements" && (
                            ...
                            >
                                <div className="flex items-center justify-between mb-4 px-1">
                                    ...
                                    <span
                                        className="text-[13px] font-bold text-gray-400 bg-gray-100 px-3 py-1 rounded-full">
                                    ...
                                    {achievements.map((achievement, index) => (
                                        ...
                                        >
                                            <div className="flex items-center gap-4">
                                                ...
                                                >
                                                    <achievement.icon
                                                        className={`w-[26px] h-[26px] ${achievement.earned ? "text-white" : "text-gray-300"}`}/>
                                                </div>
                                                <div className="flex-1">
                                                    <div className="flex items-center gap-1.5 mb-0.5">
                                                        ...
                                                        {achievement.earned && <Award
                                                            className="w-[18px] h-[18px] text-green-500 fill-green-500/20"/>}
                                                    </div>
