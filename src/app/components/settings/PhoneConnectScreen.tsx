        ...
        <div className="px-6 space-y-6">
          {step === "phone" ? (
            <>
              ...
              >
                <div className="w-20 h-20 bg-gradient-to-br from-[#091A7A] to-[#4F8EFF] rounded-full flex items-center justify-center shadow-xl">
              ...
              >
                ...
                <div className="relative">
                  <Smartphone className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#091A7A]/40" />
                  <input
                    type="tel"
                    value={phoneNumber}
              ...
              >
                <p className="text-sm text-blue-900">
                  We'll send you a verification code to confirm your number. Standard messaging rates may apply.
                </p>
              </motion.div>
            ...
            <>
              ...
              <motion.div
                ...
                className="flex justify-center pt-8"
              >
                <div className="w-20 h-20 bg-green-100 rounded-full flex items-center justify-center shadow-xl">
