  ...
  return (
    ...
    >
      <div className="relative z-10 p-5">
        <p className="text-sm font-medium text-[#577395] mb-1">
          {subtitle}
        </p>
        <p className="mb-4">
          <span className="text-3xl font-black text-[#2d4663]">{count} </span>
          <span className="text-sm font-medium text-[#577395]">{title}</span>
        </p>
