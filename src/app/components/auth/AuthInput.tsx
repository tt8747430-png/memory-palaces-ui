...
export function ValidCheckmark() {
    return (
        ...
        >
            <div
                className="w-5 h-5 bg-gradient-to-br from-[#10B981] via-[#059669] to-[#047857] rounded-full flex items-center justify-center shadow-lg ring-2 ring-white/30 relative overflow-hidden">
                <div
