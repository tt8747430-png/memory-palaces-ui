...
import {ArrowLeft, CheckCircle, Edit2, Filter, Folder, MoreVertical, Plus, Search, Trash2,} from "lucide-react";
import {StatusBar} from "../ui/StatusBar";
import {DynamicBackground} from "../DynamicBackground";
import {AmbientParticles} from "../AmbientParticles";
import {Palace, useProgressState} from "../../hooks/useProgressState";
                          ...
                          {palace.totalRooms} rooms
                              ...
                              Complete
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span
                                                    className="text-[13px] font-semibold text-[#007AFF] min-w-[45px] text-right">
                          {palace.progress}%
                        </span>
                                            </div>
                                        </div>
                                    ...
                                    <AnimatePresence>
                                        {expandedPalaceId === palace.id && (
                                            ...
                                            >
                                                <div
                                                    className="mt-4 pt-4 border-t border-[#E5E5EA] grid grid-cols-3 gap-3">
                                                    <motion.button
