                  ...
                  >
                    <div className="p-5">
                      <div className="flex items-start gap-4">
                        <div className="w-12 h-12 bg-gradient-to-br from-[#007AFF] to-[#0051D5] rounded-2xl flex items-center justify-center flex-shrink-0">
                                  ...
                                  >
                                    <div className="flex items-center gap-3">
                                      ...
                                      <div className="flex gap-2">
                                        ...
                                        >
                                          <Edit2 size={14} className="text-[#007AFF]" />
                                        </motion.button>
