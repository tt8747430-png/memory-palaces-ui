    ...
    return (
        <div className="relative w-10 h-10 flex items-center justify-center">
            ...
            >
                ...
                {/* Globe highlight */}
                <div
                    className="absolute top-1 left-1 w-3 h-3 bg-gradient-to-br from-white/40 to-transparent rounded-full"/>
            ...
            >
                <div className="w-1.5 h-2 bg-red-500 rounded-t-full relative shadow-sm">
                    <div
                        className="absolute top-0.5 left-1/2 w-0.5 h-0.5 bg-white rounded-full transform -translate-x-0.5"/>
                    <div
                        className="absolute bottom-0 left-1/2 w-0 h-0 border-l-[3px] border-r-[3px] border-t-[2px] border-l-transparent border-r-transparent border-t-red-500 transform -translate-x-0.5"/>
                </div>
            </motion.div>
            ...
            >
                <div className="w-1 h-1.5 bg-orange-500 rounded-t-full relative shadow-sm">
                    <div
                        className="absolute top-0.5 left-1/2 w-0.5 h-0.5 bg-white rounded-full transform -translate-x-0.5 scale-75"/>
                    <div
                        className="absolute bottom-0 left-1/2 w-0 h-0 border-l-[2px] border-r-[2px] border-t-[1.5px] border-l-transparent border-r-transparent border-t-orange-500 transform -translate-x-0.5"/>
                </div>
            </motion.div>
            ...
            >
                <div className="w-1 h-1.5 bg-blue-500 rounded-t-full relative shadow-sm">
                    <div
                        className="absolute top-0.5 left-1/2 w-0.5 h-0.5 bg-white rounded-full transform -translate-x-0.5 scale-75"/>
                    <div
                        className="absolute bottom-0 left-1/2 w-0 h-0 border-l-[2px] border-r-[2px] border-t-[1.5px] border-l-transparent border-r-transparent border-t-blue-500 transform -translate-x-0.5"/>
                </div>
            </motion.div>
