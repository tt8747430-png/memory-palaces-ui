    ...
    return (
        <div className="relative w-10 h-10 flex items-center justify-center">
            ...
            >
                {/* Flask neck */}
                <div
                    className="absolute top-0 left-1/2 w-1.5 h-3 bg-gradient-to-b from-gray-300 to-gray-400 transform -translate-x-0.5 rounded-t-sm"/>

                {/* Flask body */}
                <div
                    className="w-8 h-9 bg-gradient-to-br from-gray-200 to-gray-300 rounded-b-full shadow-lg relative overflow-hidden">
                    {/* Liquid */}
                    <motion.div
                    ...
                    {/* Flask highlight */}
                    <div
                        className="absolute top-1 left-1 w-2 h-3 bg-gradient-to-br from-white/50 to-transparent rounded-full"/>
                </div>

                {/* Cork/stopper */}
                <div
                    className="absolute -top-0.5 left-1/2 w-2 h-1 bg-gradient-to-b from-amber-600 to-amber-800 transform -translate-x-0.5 rounded-t-sm"/>
            </motion.div>
