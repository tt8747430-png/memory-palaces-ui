...
export function LiquidGlassBottomNav({
  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50">
      <div className="absolute inset-0 bg-gradient-to-t from-[#091A7A]/20 via-[#4F8EFF]/10 to-transparent blur-2xl scale-110 opacity-60" />

      <div className="relative w-[320px] h-20 rounded-[40px] overflow-hidden shadow-2xl">
        <div className="absolute inset-0 bg-gradient-to-br from-white/15 via-white/8 to-white/15 backdrop-blur-3xl" />

        <div className="absolute inset-0 rounded-[40px] p-[1px]">
          <div className="absolute inset-0 bg-gradient-to-br from-white/30 via-white/10 to-white/5 rounded-[40px]" />
          <div className="absolute inset-[1px] bg-gradient-to-br from-[#091A7A]/60 via-[#1a2b8a]/50 to-[#091A7A]/60 rounded-[40px]" />
        </div>
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-white/10 via-transparent to-transparent rounded-[40px] pointer-events-none" />

        <div className="absolute bottom-0 left-0 right-0 h-1/2 bg-gradient-to-t from-black/5 via-transparent to-transparent rounded-b-[40px] pointer-events-none" />
      </div>

      <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 w-[280px] h-8 bg-[#091A7A]/20 blur-xl rounded-full" />
    </div>
  );
}