...
export function OpeningAnimation({
    ...
    return (
        <div
            className="absolute inset-0 flex items-center justify-center overflow-hidden bg-gradient-to-b from-[#091A7A] to-[#ADC8FF]">
            ...
            >
                ...
                {currentPhase >= 1 && (
                    ...
                    >
                        ...
                        {/* Main Logo Container */}
                        <div
                            className="relative w-32 h-32 bg-card-glass border border-white/30 rounded-[2rem] p-6 shadow-elevated backdrop-blur-lg">
                            {/* Inner Glow */}
                            <div
                                className="absolute inset-2 bg-gradient-to-br from-white/30 to-transparent rounded-[1.5rem]"/>
