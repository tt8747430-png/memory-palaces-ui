...
function Time({
  ...
  return (
    <div className="basis-0 box-border flex gap-2.5 grow h-[22px] items-center justify-center pt-0.5 relative shrink-0">
      <div
...
function Levels({ color }: { color: string }) {
  return (
    <div className="basis-0 box-border flex gap-[7px] grow h-[22px] items-center justify-center pt-px relative shrink-0">
  ...
  return (
    <div className="relative size-full">
      <div className="flex flex-row items-center justify-center relative size-full">
        <div className="box-border flex gap-[154px] items-center justify-center pb-[19px] pt-[21px] px-4 relative size-full">
