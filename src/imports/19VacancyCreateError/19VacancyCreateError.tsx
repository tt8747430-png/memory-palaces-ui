import svgPaths from "./svg-gluaolf6ge";
import imgSymbolWarningRedH092K1 from "./214c7f00a1a42d5735dc7cb6b8632d587d8d3383.png";
import { imgSymbolWarningRedH092K } from "./svg-lga29";
...
function Field1() {
  return (
    <div className="absolute contents left-[20px] top-[204px]" data-name="field">
      <div className="absolute inset-[46.15%_5.54%_44.34%_5.54%] rounded-[12px]" data-name="field">
        <div aria-hidden="true" className="absolute border border-[#1f74ec] border-solid inset-[-0.5px] pointer-events-none rounded-[12.5px]" />
      </div>
      <p className="[word-break:break-word] absolute font-['Mulish:Medium',sans-serif] font-medium leading-[normal] left-[57px] text-[#17243e] text-[12px] top-[217px] whitespace-nowrap">(123) 456-7890 |</p>
      <p className="[word-break:break-word] absolute font-['Font_Awesome_6_Pro:Solid',sans-serif] leading-[normal] left-[36px] not-italic text-[#1f74ec] text-[14px] top-[218px] whitespace-nowrap">{`\uF095`}</p>
    </div>
  );
}
...
function Image() {
  return (
    <div className="absolute contents inset-[11.83%_30.47%_50.54%_30.75%]" data-name="image">
      ...
      <div className="absolute inset-[6.72%_25.21%_45.43%_25.48%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[19px_19px] mask-size-[140px_140px]" style={{ maskImage: `url('${imgSymbolWarningRedH092K}')` }} data-name="Symbol Warning Red.H09.2k">
        <img alt="" className="absolute inset-0 max-w-none object-bottom pointer-events-none size-full" src={imgSymbolWarningRedH092K1} />
      </div>
    </div>
  );
}
...
function Modal() {
  return (
    <div className="absolute h-[372px] left-[17px] overflow-clip top-[440px] w-[361px]" data-name="modal">
      <div className="absolute bg-white inset-0 rounded-[20px]" data-name="background" />
      <Button />
      <p className="[word-break:break-word] absolute font-['Mulish:SemiBold',sans-serif] font-semibold leading-[normal] left-[13.85%] right-[13.57%] text-[#5d6675] text-[14px] text-center top-[calc(50%+38px)]">Our team is on it! In the meantime, please try again or contact our support team for assistance</p>
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Libre_Franklin:SemiBold',sans-serif] font-semibold leading-[normal] left-[calc(50%+0.5px)] text-[#23272c] text-[20px] text-center top-[calc(50%+6px)] whitespace-nowrap">Ooops, something went wrong</p>
      <Image />
...
export default function Component19VacancyCreateError() {
  return (
    <div className="bg-white relative size-full" data-name="19-Vacancy-Create-Error">
