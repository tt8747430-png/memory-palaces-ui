...
/impeccable craft create something like this in our app. this should be all capable ai tutor, i can ask it to create rooms to create palaces to edit or search settings to edit the profile and more and more. for this it will have an interface for how to interact with our app. it will be able to do anything in our app that i will ask it to do, but first before executing it should promt me for permission for this specific action to take. it also can generate locies and quizes and so on.
 ...
 /agent-skills:plan this current app is just a ui mockup with no good structure. review this new architecture and using best practices and informations review our app to make a good architecture with some good structure and patterns like MVVM from C# and other best practices for structuring the codebase. also check what framework should be used and what ui libraries are best suitable for our app. create a plan and improve it in the  /Users/kristianbraila/projectsGIT/web/memory-palaces-app-ui/docs/ai_docs/NEW_ARCHITECHTURE.md 